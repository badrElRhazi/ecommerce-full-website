          ...
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputName">Role_ID</label>
                  <input name="role_id" id="role_id"class="form-control" >                           
                </div> 
                         
                <div class="row">
          <div class="col-12">
            <a href="#" class="btn btn-secondary">Cancel</a>
            <input type="submit" value="ADD USER" class="btn btn-success float-right" name="send">
          </div>
        </div>
              </div>
              <!-- /.card-body -->
