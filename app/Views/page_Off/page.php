...
<head>
    ...
    <!-- CSS
    ========================= -->
    <link rel="stylesheet" href="assets/front/cssf/vendor/bootstrap.min.css">
    <link rel="stylesheet" href="assets/front/cssf/slick.css">
    <link rel="stylesheet" href="assets/front/cssf/simple-line-icons.css">
    <link rel="stylesheet" href="assets/front/cssf/ionicons.min.css">
    <link rel="stylesheet" href="assets/front/cssf/font.awesome.css">
    <link rel="stylesheet" href="assets/front/cssf/animate.css">
    <link rel="stylesheet" href="assets/front/cssf/nice-select.css">
    <link rel="stylesheet" href="assets/front/cssf/jquery-ui.min.css">
    <link rel="stylesheet" href="assets/front/cssf/magnific-popup.css">
    ...
    <!-- Main Style CSS -->
    <link rel="stylesheet" href="assets/front/cssf/style.css">

    <!--modernizr min js here-->
    <script src="assets/front/jsf/vendor/modernizr-3.7.1.min.js"></script>
...
<body>
    ...
    <div class="mini_cart">
        <div class="cart_gallery">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="#"><img src="assets/front/imgf/product/product1.jpg" alt=""></a>
                </div>
                <div class="cart_info">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="#"><img src="assets/front/imgf/product/product2.jpg" alt=""></a>
                </div>
                <div class="cart_info">
                    ...
                    <div class="col-12">
                        <div class="header_container d-flex justify-content-between align-items-center">
                            ...
                            <div class="header_logo">
                                <a class="sticky_none" href="index.html"><img src="assets/front/imgf/logo/logo.png" alt=""></a>
                            </div>
                            <!--main menu start-->
                                ...
                                <ul class="d-flex">
                                    ...
                                    <li class="account_link"><a href="#"><i class="icon-user icons"></i></a>
                                        <ul class="dropdown_account_link">
                                            <li><a href="login/admin">Dashbord</a></li>
                                            <li><a href="login/user">My Account</a></li>
    ...
    <section class="slider_section mb-63">
        <div class="slider_area slick_slider_activation" data-slick='{
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="assets/front/imgf/slider/slider1.jpg">
                <div class="container">
                    <div class="row">
        ...
        <div class="container">
            ...
            <div class="banner_container d-flex">
                <figure class="single_banner position-relative mr-30">
                    <img src="assets/front/imgf/bg/bg1.jpg" alt="">
                ...
                <figure class="single_banner position-relative">
                    <img src="assets/front/imgf/bg/bg2.jpg" alt="">
                    <figcaption class="banner_text position-absolute">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <figure class="single_banner position-relative">
                        <img src="assets/front/imgf/bg/bg3.jpg" alt="">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <figure class="single_banner position-relative">
                        <img src="assets/front/imgf/bg/bg4.jpg" alt="">
            ...
            <div class="blog_container row">
                <div class="blog_slick slick_slider_activation" data-slick='{
                    ...
                    <article class="col single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="assets/front/imgf/blog/blog1.jpg" alt=""></a>
                            </div>
                    ...
                    <article class="col single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="assets/front/imgf/blog/blog2.jpg" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <div class="blog_meta">
                                    <ul class="d-flex">
                    ...
                    <article class="col single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="assets/front/imgf/blog/blog3.jpg" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <div class="blog_meta">
                                    <ul class="d-flex">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5">
                    <div class="footer_widget_list">
                        <div class="footer_logo">
                            <a href="#"><img src="assets/front/imgf/logo/logo.png" alt=""></a>
                        </div>
                ...
                <div class="col-lg-7 col-md-7 col-sm-7">
                    <div class="footer_widget_list text-right">
                        ...
                        <div class="copyright_right">
                            <p>©2021 <span>Uthr</span>. made with <i class="ion-heart"></i> by <a
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="modal_zoom_gallery">
                                    <div class="product_zoom_thumb">
                                        <img src="assets/front/imgf/product/big-product/product1.png" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
...
============================================ -->
    ...
    <script src="assets/front/jsf/vendor/jquery-3.4.1.min.js"></script>
    <script src="assets/front/jsf/vendor/popper.js"></script>
    <script src="assets/front/jsf/vendor/bootstrap.min.js"></script>
    <script src="assets/front/jsf/slick.min.js"></script>
    <script src="assets/front/jsf/wow.min.js"></script>
    <script src="assets/front/jsf/jquery.scrollup.min.js"></script>
    <script src="assets/front/jsf/images-loaded.min.js"></script>
    <script src="assets/front/jsf/isotope.pkgd.min.js"></script>
    <script src="assets/front/jsf/jquery.nice-select.js"></script>
    <script src="assets/front/jsf/tippy-bundle.umd.js"></script>
    <script src="assets/front/jsf/jquery-ui.min.js"></script>
    <script src="assets/front/jsf/jquery.instagramFeed.min.js"></script>
    <script src="assets/front/jsf/jquery.magnific-popup.min.js"></script>
    <script src="assets/front/jsf/mailchimp-ajax.js"></script>

    <!-- Main JS -->
    <script src="assets/front/jsf/main.js"></script>
